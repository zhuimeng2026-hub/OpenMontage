...
from tools.asset_upload import UploadAsset, _ALLOWED_EXTENSIONS, _SAFE_FILENAME, _max_upload_bytes
    ...
    def execute(self, inputs: dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            if operation == "start":
                ...
                state_path.write_text(json.dumps({"project_id": project_id, "filename": filename, "total_bytes": total, "mime_type": inputs.get("mime_type"), "sha256": inputs.get("sha256"), "created": time.time()}), encoding="utf-8")
            ...
            assets_dir = (root / state["project_id"] / "assets").resolve()
