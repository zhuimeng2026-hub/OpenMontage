...
window.FF_CONFIG = {
  ...
  remotion: {
    mcpUrl: "https://render.mengxa.com/api/mcp",              // Streamable HTTP MCP 端点（经 BFF 转发）
    progressUrl: "https://render.mengxa.com/api/render-progress", // SSE 实时进度：progressUrl/{jobId}
    ...
    bffBaseUrl: "https://render.mengxa.com"
  }
};
