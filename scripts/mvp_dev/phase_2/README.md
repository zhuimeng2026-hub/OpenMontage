...
范围文档:`docs/openmontage_product_video_mvp_golang_scope.md` §17.1(§17.C)
...
4. 干跑:`bash scripts/mvp_dev/phase_2/run.sh --fresh && bash scripts/mvp_dev/phase_2/gate.sh`
5. 通过后:`bash scripts/mvp_dev/orchestrator.sh --only 2`
